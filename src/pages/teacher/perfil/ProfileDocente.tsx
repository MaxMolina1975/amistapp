...
interface ActividadHistorial {
  id: string;
  tipo: 'curso' | 'estudiante' | 'material' | 'evaluacion' | 'sistema';
  titulo: string;
  descripcion: string;
  fecha: string;
...
export function ProfileDocente() {
  ...
  const [perfilActualizado, setPerfilActualizado] = useState({
    ...
    especialidad: currentUser?.specialty || 'Educación Socio-Emocional',
    acercaDeMi: currentUser?.bio || 'Docente especializado en el desarrollo de habilidades socioemocionales en estudiantes de educación básica.'
  });
  
  const [historialExpandido, setHistorialExpandido] = useState(false);
  const [cargando, setCargando] = useState(false);
  
  // Datos de ejemplo para estadísticas del docente
  const estadisticas: EstadisticasDocente = {
    estudiantes: 78,
    cursos: 3,
    materialesCreados: 45,
    puntosDados: 2350,
  ...
  const historialActividades: ActividadHistorial[] = [
    {
      ...
      descripcion: 'Has creado el material "Guía para el manejo de emociones"',
      fecha: '24/03/2025',
    ...
    },
    {
      ...
      descripcion: 'Has creado la evaluación "Test de inteligencia emocional"',
      fecha: '22/03/2025',
      icono: <BarChart className="h-5 w-5 text-purple-500" />
    },
    {
      id: '3',
      tipo: 'estudiante',
      titulo: 'Estudiante añadido',
      descripcion: 'Has añadido a Laura Martínez a tu curso "7° Básico B"',
      fecha: '20/03/2025',
    ...
    },
    {
      ...
      tipo: 'curso',
      titulo: 'Curso creado',
      descripcion: 'Has creado el curso "8° Básico A"',
      fecha: '18/03/2025',
      icono: <School className="h-5 w-5 text-orange-500" />
    },
    {
      id: '5',
      tipo: 'sistema',
      titulo: 'Puntos otorgados',
      descripcion: 'Has otorgado 150 puntos a los estudiantes de "6° Básico A"',
      fecha: '15/03/2025',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Llamada al sistema REST local para actualizar el perfil del docente
            ...
            <div className="px-4 py-5 sm:p-6">
              <div className="flex flex-col md:flex-row">
                <div className="flex-shrink-0 mb-6 md:mb-0 md:mr-8 flex flex-col items-center">
                  ...
                  {!isEditing && (
                    <div className="mt-3 bg-blue-100 px-3 py-1 rounded-full">
                      <span className="text-sm font-medium text-blue-800">Docente</span>
                    </div>
                  )}
                </div>
          ...
          <div className="px-4 py-5 sm:p-6">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="bg-blue-50 rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-xl font-bold text-blue-700">{estadisticas.estudiantes}</p>
              </div>
              ...
              <div className="bg-orange-50 rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-xl font-bold text-orange-700">{estadisticas.cursos}</p>
              </div>
              ...
              <div className="bg-green-50 rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-xl font-bold text-green-700">{estadisticas.materialesCreados}</p>
              </div>
              ...
              <div className="bg-yellow-50 rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-xl font-bold text-yellow-700">{estadisticas.puntosDados}</p>
              </div>
              ...
              <div className="bg-purple-50 rounded-lg p-4 flex flex-col items-center">
                ...
                <p className="text-xl font-bold text-purple-700">{estadisticas.evaluacionesRealizadas}</p>
              </div>
            </div>
          </div>
        </div>
