/*
  # Esquema de base de datos para la aplicación de desarrollo socioemocional

  1. Tablas principales
    - users: Información de usuarios
    - emotions: Registro de emociones
    - reports: Sistema de reportes
    - courses: Cursos y grupos
    - rewards: Sistema de recompensas
    - subscriptions: Suscripciones de profesores

  2. Tablas de relación
    - course_members: Miembros de cursos
    - point_transactions: Transacciones de puntos
    - reward_claims: Solicitudes de recompensas
*/
